...
document.addEventListener("DOMContentLoaded", function () {
  // Select the reset button and relevant elements
  const resetButton = document.querySelector(".reset");
  const searchCityInput = document.getElementById("searchCity");
  const locationName = document.getElementById("locationName");
  const temperatureValue = document.getElementById("temperatureValue");
  const weatherType = document.getElementById("weatherType");
  const realFeel = document.getElementById("realFeelAdditionalValue");
  const humidity = document.getElementById("humidityAdditionalValue");
  const maxTemp = document.getElementById("maxTemperatureAdditionalValue");
  const minTemp = document.getElementById("minTemperatureAdditionalValue");
  const windSpeed = document.getElementById("windSpeedAdditionalValue");
  const windDirection = document.getElementById("windDirectionAdditionalValue");
  const visibility = document.getElementById("visibilityAdditionalValue");
  const pressure = document.getElementById("pressureAdditionalValue");
  const sunrise = document.getElementById("sunriseAdditionalValue");
  const sunset = document.getElementById("sunsetAdditionalValue");
  ...
  resetButton.addEventListener("click", function (e) {
    ...
    // Reset weather data
    locationName.textContent = "Search City...";
    ...
    // Reset background image (optional)
    // document.body.style.backgroundImage = "url('media/day1.jpg')";

    console.log("Weather data reset to default state.");
  });
});
